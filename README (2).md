...
![Estimated completion time](https://img.shields.io/badge/Estimated%20Time-5%20hours-7FFF7F)
&nbsp;
...
<table>
  ...
  <tr>
    <td>
        ...
        <br/><br/>
        The difference between academicId and academicToViewId is:
        <ul> 
          <li>academicId belongs to the academic making the request (the requester must be a valid academic)</li>
          <li>academicToViewId belongs to the academic that the requester wants to view the details of (i.e. the academic whose details you should return)</li>
        </ul>
        <b>Difficulty</b>: ⭐
    </td>
    <td>
